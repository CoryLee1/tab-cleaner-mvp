  ...
  return (
    ...
    >
      {state.property1 === "sidebar-open" && (
        <>
          <div className="frame">
            <img className="image" alt="Image" src="/img/image-128-1.png" />
          ...
          <div className="frame-4">
            <div className="frame-5">
              <img className="img" alt="Image" src="/img/image-131-1.png" />

              <div className="text-wrapper-6">常用收藏</div>
            </div>

            <div className="frame-5">
              <img className="image-2" alt="Image" src="/img/image-133-1.png" />

              <div className="text-wrapper-7">隐私</div>
            </div>

            <div className="frame-6">
              <img className="image-3" alt="Image" src="/img/image-130-2.png" />

              <div className="text-wrapper-8">我的收藏</div>
            </div>

            <div className="frame-5">
              <img className="image-3" alt="Image" src="/img/image-130-3.png" />
          ...
          <div className="frame-7">
            <img className="image-4" alt="Image" src="/img/image-136-1.png" />
      ...
      {state.property1 === "one" && (
        <>
          <img className="vector" alt="Vector" src="/img/vector-649-2.svg" />

          <img className="vector-2" alt="Vector" src="/img/vector-649-2.svg" />

          <img className="vector-3" alt="Vector" src="/img/vector-649-2.svg" />
        </>
      )}
    </div>
  );
